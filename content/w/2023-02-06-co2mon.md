...
Discovering the DIY friendly Air Gradient device, and then shortly afterwards a very similar NZ based [open source CO2 monitor](https://github.com/oseiler2/CO2Monitor) designed by Oliver Seiler planted the seed of the idea of building CO2 monitors and an associated monitoring and management platform without any of these limitations.
...
Overall, the first iteration of co2mon.nz has clearly not been a business success.
...
While my expertise and experience is with large software systems, providing an air quality monitoring service has a significant hardware requirement - without a physical monitor to perform and report the measurements, there is no useful service to provide.
...
Despite these challenges, and despite hardware not being any area of expertise for me, the benefits of making air quality monitoring more accessible justify taking some calculated risk in this area. What's more, while still hard, it's also true that it's never been easier and more accessible to build new electronic products than it is today thanks to the growing availability of affordable, full-featured chipsets like ESP32, increasingly mature open source design tooling, accessible PCB fabrication services and generous folks like Oliver who contribute entire designs and projects to the community.

The remaining challenges to overcome here are basically chicken and egg style problems around the speed and level of financial risk/outlay I'm willing to incur in order to iterate onwards with the business.
 - Build scale vs outsourcing
 - Iteration speed vs size of batch

 Two path mitigation strategy
  - PCBA + outsourced assembly
  - Whoelesale/reseller arrangement - enabled by lower standards for hardware features.
