...
My expertise and experience is with large software systems. P  roviding an air quality monitoring service has a significant hardware requirement - without a physical monitor to perform and report the measurements, there is no useful service to provide.

Building hardware is notoriously hard. The pandemic induced supply chain chaos that has particularly afflicted the electronic component industry has reinforced the risks that have always existed when building new electronic devices. Luckily the components I've used to date have remained broadly available, but the risk of spending months of effort and development only to have to redesign around a now unavailable part or component still remains.

Despite these challenges, and despite hardware not being an area of expertise for me, the benefits of making air quality monitoring more accessible justify taking some calculated risk in this area. What's more, while still hard, it's also true that it's never been easier and more accessible to build new electronic products than it is today thanks to the growing availability of affordable, full-featured chipsets like [ESP32](https://en.wikipedia.org/wiki/ESP32), increasingly mature [open source design tooling](https://www.kicad.org/), accessible PCB fabrication services and generous folks like [Oliver](https://github.com/oseiler2) who contribute entire designs and projects to the community.
...
Outsourcing the PCB assembly (PCBA) and associated components such as the case is definitely feasible, and the costs of doing so become very reasonable with quantities as low as 100-200 devices per batch. The primary downside is that the lead time I've been quoted per batch (even by NZ-based PCBA services) is on the order of 6-8 weeks from when the design is finalised, while I'd ideally like to be able to outsource production of small 10-20 device batches with new designs every couple of weeks to support rapid product iteration and discovery.

Grappling with this challenge has forced me to re-evaluate just how important to the potential business my perceived hardware requirements actually are. If I were willing to drop the "traffic-light" green/orange/red indication functionality, and settle for a more smoke-alarm style device, perhaps with just a small screen or a single discreet LED indicator, then many of the existing products built by others that I described above would come back into consideration as a possibility: . would it be feasible to buy an existing device on a wholesale/white-label basis as the hardware platform for the co2mon.nz service? 

Given most device manufacturers are also supplying their own monitoring and management platform, it's possible that there would be no interest in supporting a potential competing service by supplying hardware in this fashion, but I think it's worth at least having the conversations and investigating the possibility rather than just assuming that's the case. From what I can see from the public marketing materials of say [Air Suite](https://www.airsuite.com/), [Tether](https://www.tether.co.nz/), their target customers are large building owners, facility managers and businesses who are likely to purchase a fleet of monitors for their entire portfolio of locations. This makes a lot of sense for a business that's aiming for significant scale - but in keeping with my goals, my current ambitions are much more niche and focused - I'd like to make air quality monitoring accessible to individuals and small businesses who don't apppear to be well served or targeted by these existing products.

If I can find a partner willing to support this approach, then I think it also takes pressure off the iteration timelines of outsourcing manufacturing of a purpose built monitor. The purchased devices can be used to support the early iteration and scaling of the business model and service offering while development and testing of what I hope will be our eventual product offering proceeds in the background until the design and production process is stable and mature enough to be relied upon.
