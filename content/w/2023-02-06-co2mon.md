...
Taking all that into consideration, I will attempt a second iteration of co2mon.nz focused on selling or renting CO2 monitors directly to small businesses/individuals and moving away from the school/charity oriented sponsorship model of the first iteration.

The attraction of a rental oriented business is that it has the potential to capture users like those from the first iteration who don't see the need to buy the device outright, but who might be curious to see what their air quality is like on a one-off basis. If they don't see the value, then the monitor can be returned and re-used by the next customer, or if they do find value in the visibility that the monitor provides then the option to pay to keep the device, either for a longer rental with integrated monitoring, or as an outright purchase of the monitor alone with the option to also subscribe to ongoing monitoring.

In addition to testing this model with local customers and my personal network as I did in the first iteration, I plan to invest in some marketing/sales support and advice to also test both the original business model and the new device rental model with a broader and wider pool of potential customers. Offering a referral program for existing customers to get benefits for referring their friends and family also seems like a useful way to reach additional potential customers and support awareness of the ability to undertake air quality monitoring in general.

The hardware outsourcing/acquisition work described above will also be an important thread of effort in parallel to testing the second iteration of the business model. The combination of the two will be my primary success metric - if I can produce or acquire sufficient CO2 monitors at a price that supports a product offering that results in each sale or rental being profitable on a unit cost basis (including time/labour costs), and each batch of devices produced is able to be sold in a reasonable period of time then I'll likely have a business that's worth continuing.

That condition is obviously not going to be immediately true, and there's some upfront/sunk costs to take into account that I'm willing to overlook for now. I think the right way to approach it will be to think about the unit cost/profitability of the next batch of monitors to be built and sold. If that next batch can be profitable (or closer to profitable) than what has come before, then things are on the right track.
