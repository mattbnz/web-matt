...
But while the concerns with the constitution and motivations behind them may be questionable, there is still a worthwhile conversation to reconcile the diverse viewpoints around what InternetNZ should be as an organisation and how .nz should be operated that needs to continue. Engaging with the conversation in recent weeks has helped confirm my opinion regarding the policies that should be applied to .nz, but unexpectedly has also led me to question whether InternetNZ's current form is going to be fit for purpose in future.
...
So the current discussions are just the latest iteration in a long, ongoing debate over how to manage the inherent tension that the dual roles that the structure of organisation presents.
...
But on the positive side it would clarify the organisation's role and allow for clearer and more focused discussions around .nz rules and policy, with lower domain registration fees for the community as a pleasing side effect.

I haven't decided whether the short-term loss would be net negative to NZ overall in the long-term, or whether other groups would take up the policy and advocacy roles in a more effective and sustainable manner than InternetNZ can achieve while trying to satisfy all stakeholders. The tension inherent between InternetNZ's dual roles has been managed to date, and thr organisation has achieved many good things, but that's not say the approach is obviously the best or only one that should be considered.

Perhaps the expectation that other organisations could fill that gap, and perhaps be more effective than InternetNZ without the domain registration revenue is wishful thinking, but as I've pondered over these topics in the last few weeks I've found it harder and harder to convince myself that the current model is easily justifiable going forward.
